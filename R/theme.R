...
theme_measr_shiny <- shinyDashboardThemeDIY(
  
  ### general
  appFontFamily = "Open Sans"
  ,appFontColor = "rgb(45,45,45)"
  ,primaryFontColor = "#8ECAE6"
  ...
  ### header
  ,logoBackColor = "#023047"
  
  ,headerButtonBackColor = "#023047"
  ,headerButtonIconColor = "#8ECAE6"
  ,headerButtonBackColorHover = "rgb(100,100,100)"
  ,headerButtonIconColorHover = "rgb(60,60,60)"
  
  ,headerBackColor = "#023047"
...
logo_measr_light <- shinyDashboardLogoDIY(
  boldText = "DCM Item Response Functions",
  mainText = "",
  textSize = 16,
  badgeText = "<a href='https://github.com/wjakethompson/dcm-probs'>@wjakethompson</a>",
  badgeTextColor = "#8ECAE6",
  badgeTextSize = 2,
  badgeBackColor = "#023047",
  badgeBorderRadius = 3
)
